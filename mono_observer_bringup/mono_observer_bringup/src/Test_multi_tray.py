...
class TrajectoryTest(Node):
    ...
    def __init__(self):
        ...
        self.goal_positions_list = [
                            [1.111, 0.8322, -0.4118],
                            [-1.4132166399999996, 1.3816826400000002, 0.32913327999999975],
                            [1.4132166399999996, -0.14278679999999988, -0.4230057999999999],
                            [-1.4132166399999996, -0.39063647999999995, 0.8973],
                            [1.4132166399999996, 1.32953232, 0.32913327999999975],
                            [-1.4132166399999996, -1.4768738399999999, 0.8973]
                        ]
